    ...
    <section id="services" className="py-24 bg-gradient-to-b from-white to-slate-50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.h2
          ...
          className="text-4xl font-bold text-center text-blue-950 mb-4"
        >
          Financial Services
        </motion.h2>
          ...
          {services.map((service, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-white/70 backdrop-blur-lg border border-slate-200 p-8 rounded-2xl shadow-sm hover:shadow-2xl hover:-translate-y-2 transition duration-300 text-center"
              >
                {/* ICON BADGE */}
                <div className="w-14 h-14 mx-auto mb-5 rounded-xl bg-gradient-to-tr from-blue-900 to-blue-600 text-white flex items-center justify-center group-hover:scale-110 transition">
                  <Icon size={26} />
                </div>

                <h3 className="font-semibold text-blue-950 leading-snug">
                  {service.title}
                </h3>
              </motion.div>
            );
